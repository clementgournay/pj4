					...
					<div class="item-wrapper">
						...
						<div class="item-details">
							<div class="product-name">
								...
								<a class="privatisation" href="<?php echo get_site_url(); ?>/mon-compte/privatisation/planifier?product_id="<?php echo $item->get_product_id(); ?>" title="Planifier une privatisation"><i class="fa fa-calendar-alt"></i> Planifier une privatisation</a>
