			...
			if ( $product && $product->exists() ) :
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<td class="product-name">
						...
						<a class="privatisation" href="<?php echo get_site_url(); ?>/mon-compte/privatisation/planifier?product_id="<?php echo $item->get_product_id(); ?>" title="Planifier une privatisation"><i class="fa fa-calendar-alt"></i></a>
