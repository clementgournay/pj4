				...
				<div id="top">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 top-1">
							...
							<span class="contact"><i class="icon-envelope"></i> <?php echo esc_html($gon_options['header_contact']); ?></span>
							<?php } ?>
							<?php if(!empty($gon_options['header_hotline']) || ($gon_options['header_hotline'] != '')) { ?>
								<span class="hotline"><i class="icon-phone"></i> <?php echo esc_html($gon_options['header_hotline']); ?></span>
							<?php } ?>
						</div>
