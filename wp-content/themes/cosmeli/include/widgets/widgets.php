...
get_template_part( 'include/widgets/social-link/social-link' );
get_template_part( 'include/widgets/recent-posts/recent-posts' );
get_template_part( 'include/widgets/icon-box/icon-box' );

add_action( 'widgets_init', array( 'gon_Widget_Attributes', 'setup' ) );

class gon_Widget_Attributes {
	const VERSION = '0.2.2';
	...
	public static function _input_fields( $widget, $return, $instance ) {
		...
		<p>
			<?php printf(
				...
				esc_html__( 'Extra Class', 'cosmeli' )
			) ?>
			<?php
			printf(
