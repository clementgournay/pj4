...
class GonThemes_Recent_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'gon_recent_posts',
			__( 'GonThemes: Recent posts', 'cosmeli' ),
			array( 'description' => esc_html__( 'Display recent posts', 'cosmeli' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo esc_attr($this->get_field_id( 'title_widget' )); ?>"><?php esc_html_e( 'Title:', 'cosmeli' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php esc_html_e( 'Number of recent posts to show:', 'cosmeli' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr($this->get_field_id( 'display_time' )); ?>"><?php esc_html_e( 'Display post date:', 'cosmeli' ); ?></label>
				...
				<li>
					...
					<div class="post_info">
						<?php if ( $instance['display_time'] && $instance['display_time'] == 'on' ) { ?>
							<div
								class="time"><?php printf( esc_html__( '%s', 'cosmeli' ), get_the_date( 'M d, Y' ) ); ?></div>
						<?php } ?>
						<div class="title">
