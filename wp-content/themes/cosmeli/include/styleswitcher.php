...
//Style Switcher
function gon_style_switcher() { ?>
    <div class="style-switcher hidden-xs hidden-sm hidden-md">
		<div class="stoggler"><i class="fa fa-cog"></i></div>
		<div class="spanel">
			<h2><?php esc_html_e('Style Switcher', 'cosmeli'); ?></h2>
			<form name="styleswitcher" action="<?php echo esc_url(home_url('/')); ?>" method="post">
				<div class="layout">
					<select name="slayout" class="slayout">
						<option value=""><?php esc_html_e('-- Select Layout --', 'cosmeli'); ?></option>
						<option value="full"><?php esc_html_e('Full Width', 'cosmeli'); ?></option>
						<option value="box"><?php esc_html_e('Box', 'cosmeli'); ?></option>
					</select>
				</div>
				<div class="bg-color">
					<h3><?php esc_html_e('Background Color', 'cosmeli'); ?></h3>
				...
				<div class="bg-image">
					<h3><?php esc_html_e('Background Image', 'cosmeli'); ?></h3>
				...
				<button type="button" id="resetpreview" class="btn btn-primary"><?php esc_html_e('Reset', 'cosmeli'); ?></button>
				<div class="presets">
					<h2><?php esc_html_e('Preset Switcher', 'cosmeli'); ?></h2>
					<ul id="preset" class="preset">
						<li><a class="preset1" href="?preset=1"><?php esc_html_e('Preset 1', 'cosmeli'); ?></a></li>
						<li><a class="preset2" href="?preset=2"><?php esc_html_e('Preset 2', 'cosmeli'); ?></a></li>
						<li><a class="preset3" href="?preset=3"><?php esc_html_e('Preset 3', 'cosmeli'); ?></a></li>
						<li><a class="preset4" href="?preset=4"><?php esc_html_e('Preset 4', 'cosmeli'); ?></a></li>
					</ul>
				</div>
			</form>
		</div>
...
if(isset($gon_options['enable_sswitcher'])) {
	if($gon_options['enable_sswitcher']) {
		add_action('wp_footer', 'gon_style_switcher');
	}
}
?>